	...
	pub fn for_chain(chain_type: &global::ChainTypes) -> GlobalConfig {
		...
		match *chain_type {
			...
			global::ChainTypes::Floonet => {
				defaults.api_http_addr = "127.0.0.1:24413".to_owned();
				defaults.p2p_config.port = 24414;
				defaults
					.stratum_mining_config
					.as_mut()
					.unwrap()
					.stratum_server_addr = Some("127.0.0.1:24416".to_owned());
				defaults
					.stratum_mining_config
					.as_mut()
					.unwrap()
					.wallet_listener_url = "http://127.0.0.1:24415".to_owned();
			}
			global::ChainTypes::UserTesting => {
				defaults.api_http_addr = "127.0.0.1:34413".to_owned();
				defaults.p2p_config.port = 34414;
				defaults.p2p_config.seeding_type = p2p::Seeding::None;
				defaults
					.stratum_mining_config
					.as_mut()
					.unwrap()
					.stratum_server_addr = Some("127.0.0.1:34416".to_owned());
				defaults
					.stratum_mining_config
					.as_mut()
					.unwrap()
					.wallet_listener_url = "http://127.0.0.1:34415".to_owned();
			}
...
impl GlobalWalletConfig {
	...
	pub fn for_chain(chain_type: &global::ChainTypes) -> GlobalWalletConfig {
		...
		match *chain_type {
			global::ChainTypes::Mainnet => {}
			global::ChainTypes::Floonet => {
				defaults.api_listen_port = 24415;
				defaults.check_node_api_http_addr = "http://127.0.0.1:24413".to_owned();
			}
			global::ChainTypes::UserTesting => {
				defaults.api_listen_port = 34415;
				defaults.check_node_api_http_addr = "http://127.0.0.1:34413".to_owned();
			}
			global::ChainTypes::AutomatedTesting => {
				panic!("Can't run automated testing directly");
			}
